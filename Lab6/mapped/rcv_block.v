...
module flex_counter_NUM_CNT_BITS4_0 ( clk, n_rst, clear, count_enable, 
  ...
  wire   n1, n2, n3, n4, n5, n6, n12, n13, n14, n15, n16, n17, n18, n19, n20,
         ...
         n35, n36, n37, n38, n42, n43, n44;

  DFFSR \count_reg[0]  ( .D(n42), .CLK(clk), .R(n_rst), .S(1'b1), .Q(
        count_out[0]) );
  DFFSR \count_reg[1]  ( .D(n38), .CLK(clk), .R(n_rst), .S(1'b1), .Q(
        count_out[1]) );
  DFFSR \count_reg[2]  ( .D(n43), .CLK(clk), .R(n_rst), .S(1'b1), .Q(
        count_out[2]) );
  ...
  OAI22X1 U8 ( .A(n1), .B(n2), .C(n3), .D(n4), .Y(n37) );
  OAI22X1 U9 ( .A(n5), .B(n2), .C(n6), .D(n4), .Y(n38) );
  INVX1 U10 ( .A(n12), .Y(n42) );
  AOI22X1 U11 ( .A(count_out[0]), .B(n13), .C(n14), .D(n15), .Y(n12) );
  OAI22X1 U12 ( .A(n16), .B(n2), .C(n17), .D(n4), .Y(n43) );
  INVX1 U13 ( .A(n15), .Y(n4) );
  INVX1 U14 ( .A(n13), .Y(n2) );
  OAI21X1 U15 ( .A(n18), .B(n19), .C(n20), .Y(n44) );
  NAND2X1 U16 ( .A(rollover_flag), .B(n13), .Y(n20) );
  NAND2X1 U17 ( .A(n21), .B(n22), .Y(n19) );
  XOR2X1 U18 ( .A(n3), .B(rollover_val[3]), .Y(n22) );
  XOR2X1 U19 ( .A(n23), .B(n24), .Y(n3) );
...
module timer ( clk, n_rst, enable_timer, shift_strobe, packet_done );
  ...
  flex_counter_NUM_CNT_BITS4_1 shift_strober ( .clk(clk), .n_rst(n_rst), 
        .clear(n1), .count_enable(enable_timer), .rollover_val({1'b1, 1'b0, 
        1'b1, 1'b0}), .rollover_flag(shift_strobe) );
  flex_counter_NUM_CNT_BITS4_0 packet_sensor ( .clk(clk), .n_rst(n_rst), 
...
module rcv_block ( clk, n_rst, serial_in, data_read, rx_data, data_ready, 
  ...
  rx_data_buff rickastley ( .clk(clk), .n_rst(n_rst), .load_buffer(load_buffer), .packet_data(packet_data), .data_read(data_read), .rx_data(rx_data), 
